<template>
  <div class="sdet-container">
    ...
    <div class="mobile-header">
      ...
      <h2 class="mobile-title">{{ currentSection || 'AI Developer' }}</h2>
    </div>
    ...
    <main class="content">
      ...
      <div v-else class="welcome-screen">
        ...
        <h1>Welcome to AI Developer</h1>
        <p>Master AI, Machine Learning & LLMs</p>
...
import aiTasksRaw from '../data/aiDeveloperTasks.json';
import aiInterviewQARaw from '../data/aiInterviewQA.json';
...
const interviewCategories = Object.values(aiInterviewQARaw);
...
const sections = computed(() => [
  {
    ...
    icon: '🧠',
    tasks: toTaskArray(aiTasksRaw).slice(0, 3),
    categories: [],
  },
  {
    id: 'deep-learning',
    title: 'Deep Learning',
    icon: '🔬',
    tasks: toTaskArray(aiTasksRaw).slice(3, 5),
    categories: [],
  },
  {
    id: 'llms',
    ...
    icon: '💬',
    tasks: toTaskArray(aiTasksRaw).slice(4, 7),
    categories: [],
  },
  {
    id: 'ai-applications',
    ...
    icon: '🚀',
    tasks: toTaskArray(aiTasksRaw).slice(6, 10),
    categories: [],
  },
  {
    id: 'interview',
